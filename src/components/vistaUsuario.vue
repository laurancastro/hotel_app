...
<script>
    ...
    export default {
        ...
        methods: {
            verReservas(e){
                this.axios.get("https://hotel-api-grupo13.herokuapp.com/perfil/reservas/" + localStorage.getItem('currentEmail'))
                .then((result)=>{
            ...
            verDatos(e){
                this.axios.get("https://hotel-api-grupo13.herokuapp.com/usuarios/" + localStorage.getItem('currentEmail'))
                .then((result)=>{
